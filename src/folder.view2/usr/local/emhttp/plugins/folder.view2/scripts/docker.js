        ...
        case 4:
                addPreview = (id, ctid, autostart) => {
                    ...
                    if(folder.settings.context === 2 || folder.settings.context === 0) {
                        ...
                        tmpId.removeAttr("onclick");
                        if(folder.settings.context === 2) {
                            return tmpId.length>0 ? tmpId : $(`tr.folder-id-${id} div.folder-preview span.inner:last > span.appname`).attr("id", "folder-preview-" + ctid);
                        }
                    }
                };
                break;
                                        ...
                                        datasets: [
                                            {
                                                label: 'CPU',
                                                data: CPU,
                                                borderColor: getComputedStyle(document.documentElement).getPropertyValue('--folder-view2-graph-cpu'),
                                                backgroundColor: getComputedStyle(document.documentElement).getPropertyValue('--folder-view2-graph-cpu'),
                                                tension: 0.4,
                                                pointRadius: 0,
                                                borderWidth: 1
                                            }
                                        ...
                                        datasets: [
                                            {
                                                label: 'MEM',
                                                data: MEM,
                                                borderColor: getComputedStyle(document.documentElement).getPropertyValue('--folder-view2-graph-mem'),
                                                backgroundColor: getComputedStyle(document.documentElement).getPropertyValue('--folder-view2-graph-mem'),
                                                tension: 0.4,
                                                pointRadius: 0,
                                                borderWidth: 1
                                            }
